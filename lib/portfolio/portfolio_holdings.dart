            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(
                      _displayInvested.toStringAsFixed(2),
                      style:
                          TextStyle(fontSize: 22, fontWeight: FontWeight.w400),
                    ),
                    Text(
                      _displayCurrent.toStringAsFixed(2),
                      style: TextStyle(
                          fontSize: 22,
                          fontWeight: FontWeight.w400,
                          color:
                              getPnlColor(_displayCurrent - _displayInvested)),
                    ),
                  ],
                ),
                SizedBox(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      '${pnl.toStringAsFixed(2)} (${_displayPnL.toStringAsFixed(2)}%)',
                      style: TextStyle(fontSize: 16, color: getPnlColor(pnl)),
                    ),
                  ],
                ),
              ],
                    ...
                    return InkWell(
                      onTap: () {
                        ...
                        showDialog(
                          context: context,
                          builder: (context) =>
                              DailogWidgetHolding(index, holding_list),
                        ).then((_) {
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          '${holding_list[index]?.rate.toStringAsFixed(2)}',
                                          style: TextStyle(
                                            fontSize: 13,
                                            color: Colors.grey.shade900,
                                          ),
                                ...
                                Text(
                                  '${(holding_list[index]!.quantity * (holding_list[index]!.realRate - holding_list[index]!.rate)).toStringAsFixed(2)}',
                                  style: TextStyle(
                                    fontSize: 14,
                                    color: getPnlColor(
                                        holding_list[index]!.realRate -
                                            holding_list[index]!.rate),
                                  ),
                                ),
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  holding_list[index]!.stockName,
                                  style: TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.w400),
                                ),
                                Text(
                                  '${(holding_list[index]!.realRate * holding_list[index]!.quantity).toStringAsFixed(2)}',
                                  style: TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.w400,
                                      color: getPnlColor(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      '(${(holding_list[index]!.realRate - holding_list[index]!.rate).toStringAsFixed(2)}%)',
                                      style: TextStyle(
                                          fontSize: 13,
                                          color: getPnlColor(
                                              holding_list[index]!.realRate -
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                        flex: 2,
                        child: Text(
                          widget.dialog_stock[widget.i]!.stockName,
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${widget.dialog_stock[widget.i]!.rate}',
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () {
                        ...
                        if (int.parse(quantityController.text) > 0) {
                          int add = widget.dialog_stock[widget.i]!.quantity +
                              int.parse(quantityController.text);
                          updateStockQuantity(
                              widget.dialog_stock[widget.i]!.id, add);
                          // addData();
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        padding: EdgeInsets.symmetric(
                            horizontal: 36, vertical: 10), // Button padding
                      ),
                      child: Text(
                        'BUY',
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        if (int.parse(quantityController.text) > 0 &&
                            int.parse(quantityController.text) <=
                                widget.dialog_stock[widget.i]!.quantity) {
                          if (int.parse(quantityController.text) ==
                              widget.dialog_stock[widget.i]!.quantity) {
                            deleteStockFromHolding(
                                widget.dialog_stock[widget.i]!.id);
                          } else {
                            int remaining =
                                widget.dialog_stock[widget.i]!.quantity -
                                    int.parse(quantityController.text);
                            updateStockQuantity(
                                widget.dialog_stock[widget.i]!.id, remaining);
                          }
                        }
                        // call reloadHolding function here
                        reloadStock();
  ...
  Future<void> updateStockQuantity(String id, int newQuantity) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
            'Failed to update stock quantity. Status code: ${response.statusCode}');
      }
    } catch (error) {
